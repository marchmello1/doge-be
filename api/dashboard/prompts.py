def get_general_prompt(source_state: str, target_state: str) -> str:
    ...
    return f"""Return a JSON object that compares the following general information between {source_state} and {target_state}. The descriptions should be single sentence strictly under 20 words summarizing the key differences:
{{
    "data": [
        {{
            "title": "Tax Rates",
